                    ...
                    <Sdui.FlexContainer className="sdui-Home-wrapper" direction="row" align="center">
                        <Sdui.FlexContainer spacing="medium" fullWidth align="start">
                            ...
                            <div className="sdui-Home-par">
                                <Sdui.Paragraph>
                                    Vous cherchez à développer votre activité sur le web, mais vous êtes perdu
                                    face à tous les outils disponibles ? Safari Digital vous accompagne dans
                                    cette nouvelle aventure.
                                </Sdui.Paragraph>
                                <Sdui.Paragraph>
                                    Stratégie marketing, création de contenus, emailing, Comunity management,
                                    SEO, Google Ads... Nous mettons notre expertise au profit de votre projet.
                                </Sdui.Paragraph>
                                <Sdui.Paragraph>
                                    Embarquez pour un voyage palpitant au coeur du marketing digital et suivez
                                    le guide !
                                </Sdui.Paragraph>
                            </div>
                        </Sdui.FlexContainer>
